...
const COVERAGES = [
  ...
  {
    icon: faBuilding,
    title: 'ACI-Trained · Bonded & Insured',
    detail: 'Licensed contractor for Central Texas work',
  },
  {
    icon: faBriefcase,
    title: 'ACI-Trained Finishers',
    detail: 'Concrete and flatwork poured by local Waco crews',
  },
  {
    icon: faFileContract,
    ...
    return (
      <div className={styles.inlineBadge}>
        ...
        <span className={styles.inlineText}>
          ACI-Trained · Bonded & Insured · bonded & insured · ACI-Trained Finishers
        </span>
      </div>
    );
  }
        ...
        >
          ...
          <div className={styles.headerText}>
            ...
            <p className={styles.subtitle}>
              ...
              contractor, and our 5-Year Workmanship Warranty. You get peace of mind —
