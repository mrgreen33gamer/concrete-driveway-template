...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'IronPath Concrete',
  address       = '1800 S University Parks Dr, Waco, TX 76706',
  phone         = '(254) 750-4400',
  email         = 'hello@ironpathconcrete.com',
  googleMapsUrl = 'https://maps.google.com/?q=IronPath+Concretery+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with custom driveways, patios, and foundations.
          </p>
        </div>
