...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every project is led by ACI-trained finishers with full insurance. No fly-by-night crews.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every concrete contractor in Central Texas makes promises. We back ours in writing — with flat-rate quotes, crew-poured quality, and a 5-Year Workmanship Warranty on every pour.
          </p>
          <Link
            href={ctaLink}
