...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Crew-poured custom concretery',            us: true,  others: 'Sometimes' },
  ...
  { feature: 'Residential & commercial flatwork',      us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'IronPath vs. The Other Guys' }: ValueComparisonProps) {
  return (
