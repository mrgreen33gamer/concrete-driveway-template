...
const INDUSTRIES = [
  ...
  { slug: 'interior-designers',      label: 'Property Management',        icon: faDraftingCompass },
  { slug: 'commercial-hospitality',  label: 'Municipalities & Public Works',  icon: faHotel },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Concretery and flatwork programs built for how your organization actually works.',
  disableLinks = false,
