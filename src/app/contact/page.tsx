...
// IronPath Concrete — Contact Page (unique build, not just a form import)
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 750-4400 or fill out the form below. We respond to most requests within one business day and can usually schedule an on-site measure within the week.",
  },
  {
  ...
  {
    question: 'Do you handle commercial flatwork projects?',
  ...
  },
  {
    ...
    answer: "Our installer will tell you honestly after the assessment. If repair or refinish will restore the concrete, we recommend that first — full replacement only when it makes sense. We'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Concrete Done Right</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@ironpathconcrete.com',
                  href:      'mailto:hello@ironpathconcrete.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1800 S University Parks Dr, Waco TX 76706',
                  href:      'https://maps.google.com/?q=1800+S+University+Parks+Dr+Waco+TX+76706',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose IronPath</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '5-Year Workmanship Warranty on every install',
                'crew-poured, licensed installers only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A IronPath specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547504400">(254) 750-4400</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 750-4400 — free on-site estimates, flat-rate pricing, 5-Year Workmanship Warranty."
