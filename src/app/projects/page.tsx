...
export default function ProjectsPage() {
  return (
    <main className={styles.pageWrapper}>
      <SectionIntro
        title="Our Projects"
        subtitle="Driveways, patios, foundations, decorative pours, repairs, and commercial flatwork across Central Texas — see what's possible for your property"
      />

      {beforeAfterItems.length > 0 && (
        <div className={styles.section}>
          <BeforeAfter
            title="Real Pours. Real Results."
      ...
      <div className={styles.section}>
        <ProjectCardGrid
          ...
          subtitle="Driveways, patios, foundations, stamped concrete, repairs, and commercial flatwork across Central Texas — click any card for the full story"
        />
      </div>
