    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>IronPath Concrete &amp; Flatwork — Blog</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas homeowners — custom vs semi-concrete driveways, materials for Central Texas, and when to reface or replace.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need custom concretery in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been building concrete driveways for Waco-area homes and businesses since 2008. Free in-home estimate, no obligations.
            </p>
